...
#
# Manifest file for Leet.Build.Arguments module.
#########################################################################################
...
@{
    ...
    FunctionsToExport = @('Find-CommandArgument',
    ...
    FileList = @('Leet.Build.Arguments.psm1',
                 'Leet.Build.Arguments.Resources.psd1')
