...
#
# Manifest file for Leet.Build.Commands module.
#########################################################################################
...
@{
    ...
    Description = 'Provides build command recoverability and execution.'
    ...
    RequiredModules = @('Leet.Build.Logging',
