...
#
# Manifest file for Leet.Build.Common module.
#########################################################################################
...
@{
    ...
    Description = 'Provides functionality common for all Leet.Build modules.'
    ...
    FileList = @('Leet.Build.Common.psm1',
                 'Leet.Build.Common.Resources.psd1')
