...
#
# Localized resources for Leet.Build module.
#########################################################################################
...
Error_UnregisterBuildExtension_Reason = Could not unregister build extesion: {0}
Exception_ExtensioNotFound_ExtensionName = Build extension '{0}' has not been registered. Please make sure that the extension name is specified correctly. To list all available build extensions use 'help' command.
...
Reason_ExtensionProjectResolverInvalidArray_ExtensionName_ArrayLength = Project resolver for extension '{0}' returned array of invalid length: {1}. Supported proejct resolver output is a single String as indication of resolved project path for the same extension or 2 items array as an indication of resolver project path and name of the extension that shall be used for further project resolution respectively. Please contact with extension development team for further instructions.
Reason_RepositoryProjectResolverInvalidArray_ArrayLength = Project resolver for repository returned array of invalid length: {0}. Supported proejct resolver output is a single String as indication of resolved project path for responsible extension detection or 2 items array as an indication of resolver project path and name of the extension that shall be used for further project resolution respectively. Please make sure that the repository project resolver returns data in compliance with this contract.
Reason_RepositoryProjectResolverInvalidType_TypeName = Project resolver for repository returned invalid data type: '{0}'. Supported proejct resolver output is a single String as indication of resolved project path for responsible extension detection or 2 items array as an indication of resolver project path and name of the extension that shall be used for further project resolution respectively. Please make sure that the repository project resolver returns data in compliance with this contract.
Reason_ExtensionProjectResolverInvalidType_ExtensionName_TypeName = Project resolver for extension '{0}' returned invalid data type: '{1}'. Supported proejct resolver output is a single String as indication of resolved project path for the same extension or 2 items array as an indication of resolver project path and name of the extension that shall be used for further project resolution respectively. Please contact with extension development team for further instructions.
