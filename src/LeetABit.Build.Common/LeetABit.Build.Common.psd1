...
#
# Manifest file for LeetABit.Build.Common module.
#########################################################################################

@{

    # Script module or binary module file associated with this manifest.
    RootModule = 'LeetABit.Build.Common.psm1'
    ...
    Description = 'Provides functionality common for all LeetABit.Build modules.'
    ...
    FunctionsToExport = @('Convert-DictionaryToPSObject',
                          'Format-String',
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            Tags = @('Leet a Bit', 'LeetABit', 'Build')
