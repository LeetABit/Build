...
#
# Manifest file for LeetABit.Build.Logging module.
#########################################################################################
...
@{
    ...
    Description = 'Provides logging functionality for all LeetABit.Build modules.'
    ...
    FileList = @('LeetABit.Build.Logging.psm1',
                 'LeetABit.Build.Logging.Resources.psd1')
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            Tags = @('Leet a Bit', 'LeetABit', 'Build', 'Logging')
