...
#
# Manifest file for LeetABit.Build module.
#########################################################################################
...
@{
    ...
    RequiredModules = @(
        @{ModuleName = 'LeetABit.Build.Arguments'; ModuleVersion = '0.0.3'; },
        @{ModuleName = 'LeetABit.Build.Common'; ModuleVersion = '0.0.3'; },
        @{ModuleName = 'LeetABit.Build.Extensibility'; ModuleVersion = '0.0.3'; },
        @{ModuleName = 'LeetABit.Build.Help'; ModuleVersion = '0.0.3'; },
        @{ModuleName = 'LeetABit.Build.Logging'; ModuleVersion = '0.0.3'; }
    )
    ...
    FileList = @('LeetABit.Build.psm1',
                 'LeetABit.Build.Resources.psd1')
